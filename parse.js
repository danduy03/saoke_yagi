...
async function main() {
  ...
  const vietin = await CTTU_Vietin_10_12();

  const allTrans = [...vcb, ...bidv, ...vietin, ...agri].sort((a, b) =>
...
// file Mặt trận tổ quốc ngày 01-10/09/2024 (VCB)
...
// File Mặt trận tổ quốc ngày 01-12/09/2024 (BIDV)
...
// File MTTQ Hà nội 9-13/9 (Agribank)
...
// file Cứu trợ trung ương ngày 10-12/09/2024 (Vietinbank)
async function CTTU_Vietin_10_12(
  pdfPath = "./data/input/CTTU_Vietin_10-12.pdf",
  outputPath = "./data/output/CTTU_Vietin_10-12"
) {
  console.log("Loading PDF file... " + pdfPath);
  const parser = new PdfDataParser({ url: pdfPath });
